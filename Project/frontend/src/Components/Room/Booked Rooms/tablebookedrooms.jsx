...
const BookedRoomsTable = () => {
  ...
  const fetchData = async () => {
    try {
        ...
        const response = await fetch(`https://lavender-iron-azimuth.glitch.me/getBookedrooms?arrivaldate=${date}&departuredate=${date}`);
        ...
        <tfoot>
          <tr>
            <td colSpan={columns.length} className="text-center">
              <span>Total Booked Rooms: {data.length}</span>
            </td>
          </tr>
        </tfoot>
      </table>
